...
/**
 * The Number class holds an Integer that can be lated used in other
 * evaluations.
 * 
 * @author Rakesh Nori
 * @version 3/20/2018
...
public class Number extends Expression
{
    ...
    /**
     * @Override Gives the number
     * @param env the environment containing variables that can be used during
     *            evaluation.
