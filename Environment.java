 ...
 * Variables through its HashMap. It uses child and parent environments to
 * establish a hierarchy of local and global variables.
 * 
 * @author Rakesh Nori
 * @version 3/20/2018
 */
public class Environment
{
    ...
    /**
     * Instantiates the Map & procedure Map object by making a new HashMap that
     * uses String and Integers for the Key Value pair.
     * 
     ...
     * 
     * @return the HashMap containing variables and their values (not the
     *         procedure map).
     */
